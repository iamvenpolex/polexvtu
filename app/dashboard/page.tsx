...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-3 sm:p-6">
      {/* Reduced large screen width but mobile stays edge-to-edge */}
      <div className="max-w-5xl mx-auto space-y-4 sm:space-y-6">
        {/* Wallet Dashboard */}
        <div className="bg-white rounded-xl shadow-md p-3 sm:p-6">
          <div className="flex items-center justify-between">
            <h1 className="text-base sm:text-xl font-semibold text-blue-900">
        ...
        <div className="bg-white rounded-xl shadow-md p-3 sm:p-6">
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <Link
              ...
              className="flex flex-col items-center justify-center gap-1 sm:gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 sm:py-4 rounded-lg shadow text-xs sm:text-sm"
            >
            ...
            <Link
              ...
              className="flex flex-col items-center justify-center gap-1 sm:gap-2 bg-red-500 hover:bg-red-600 text-white font-medium py-2 sm:py-4 rounded-lg shadow text-xs sm:text-sm"
            >
        ...
        <div className="bg-white rounded-xl shadow-md p-3 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            ...
            <Link
              ...
              className="flex flex-col items-center gap-1 sm:gap-2 bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-2 sm:py-4 rounded-lg shadow transition text-xs sm:text-sm"
            >
